...
class AuthController extends GetxController {
  ...
  void logInUsingFirebase({
    ...
    try {
      ...
      if (error.code == 'user-not-found'.tr) {
        ...
        message = 'The password is invalid or the user does not have a password.'.tr;
      } else {
        message = error.message.toString();
      }
      Get.snackbar(
  ...
  void faceBookSignUpApp() async {
    ...
    if (loginResult.status == LoginStatus.success) {
      ...
      isSignedIn = true;
      displayUserName.value = faceBookModel!.name! == null ?displayUserName.value = faceBookModel!.name! : displayUserName.value =faceBookModel!.name! ;
      authBox.write("auth", isSignedIn);
